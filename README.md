...
### Étape 2 — Donner les droits sur le dossier (si c'est un serveur)
...
## Le frontend n'a pas besoin de fichier `.env`. Toute la configuration se fait uniquement dans le `.env` du Backend
...
source /home/votre_utiliateur/admin-openrc

openstack server list   # Liste des services
